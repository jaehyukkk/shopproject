...
<html lang="en">
  ...
  <body class ="main_body">
   ...
   <center>
       <h5 class="list-category-title">SEARCH</h5>
       
    </center>
   

    <center>
        <div class="searchPageInput">
            <div>
                <form action="/search">
                    <input type="text"name="search"> 
                </form>
            </div>
           <div><i class="fas fa-search" id="searchIcon"></i></div>  
        </div>
    </center>
    ...
    <div class="container">
        ...
        <div id="searchResult">
            총 <b>{{ $count }}</b>개 의 상품이 검색되었습니다.
        </div>

        <div class="row">
             @if($count == 0)
                <center><b>검색 결과가 없습니다.</b></br>
