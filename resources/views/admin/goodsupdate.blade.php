...
<head>
    ...
    <script type="text/javascript" src="{{ URL::asset('/js/admin/goodsupdate.js') }}" defer></script>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                {{-- <i class="fas fa-plus-circle" id="plusIcon"> --}}
                  ...
                  <form method="post" action="/goodsupdate" enctype="multipart/form-data">
                    @csrf
                          ...
                          <div class="content" style="width: 80%">
                              ...
                              <div class="row justify-content-md-center">
                                  ...
                                  <div class="input-group mb-3">
                                      <div class="input-group-prepend">
                                        ...
                                        <input type="text" class="form-control" name ="goods_title" value="{{ $goods->goods_title }}">              
                                      </div>
                                      ...
                                      <div class="input-group mb-3">
                                        <div class="input-group-prepend">
                                          ...
                                          <?php $color = json_decode($goods->goods_color)?>
                                          @if(count($color) === 1)
                                          <input type="text" class="form-control" name ="goods_color[]" value="{{ $color[0] }}">  
                                          <button id="add_btn" class="btn btn-primary">컬러 추가</button> 
                                        </div>
                                          @elseif(count($color) > 1)
                                          <input type="text" class="form-control" name ="goods_color[]" value="{{ $color[0] }}">  
                                          <button id="add_btn" class="btn btn-primary">컬러 추가</button> 
                                        </div>
                                            @for($i = 1; $i < count($color); $i++)
                                                ...
                                                <input type="text" class="form-control" value="{{ $color[$i] }}" name ="goods_color[]">
                                      ...
                                      <div class="input-group mb-3">
                                        ...
                                        <div class="input-group mb-3">
                                          <div class="input-group-prepend">
                                            ...
                                            <input type="text" class="form-control" name ="size" value="{{ $goods->size }}">              
                                          </div>
                                          <div class="row justify-content-md-center">
                                            <div class="input-group mb-3">
                                              <div class="input-group-prepend">
                            ...
                            <div class="row justify-content-md-center">
                                <div class="col_c" style="margin-bottom: 30px">
                                      <div class="input-group">                 
                                        <textarea class="form-control" id="editor4" name = "goods_description">
